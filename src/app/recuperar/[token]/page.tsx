...
export default function RestablecerPage() {
  ...
  const verificarToken = async () => {
    try {
      const response = await fetch(`/api/auth/recuperar?token=${token}`);
  ...
  if (verificando) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex items-center justify-center p-4">
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-8 max-w-md w-full border border-purple-500/20 shadow-2xl">
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">Verificando Token</h2>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex items-center justify-center p-4">
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-8 max-w-md w-full border border-purple-500/20 shadow-2xl">
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">Token Inválido</h2>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex items-center justify-center p-4">
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-8 max-w-md w-full border border-purple-500/20 shadow-2xl">
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">¡Contraseña Actualizada!</h2>
            <p className="text-gray-300 mb-6">
